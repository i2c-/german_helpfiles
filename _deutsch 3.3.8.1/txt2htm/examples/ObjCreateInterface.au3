...
Func Example()
	...
	MsgBox(4096, "", "Schau auf die Taskbar und du solltest einen Eintrag f&uuml;r den Editor finden." & @CRLF & @CRLF & "OK dr&uuml;cken um fortzufahren.")

	; L&ouml;scht den Editor Eintrag aus der Taskbar.
	$oTaskbarList.DeleteTab($hNotepad)

	; Weist den User daraufhin, er hinsehen soll.
	MsgBox(4096, "", "Schau auf die Taskbar.  Dort sollte nun kein Eintrag mehr f&uuml;r den Editor vorhanden sein obwohl er immer noch l&auml;uft." & @CRLF & @CRLF & "OK dr&uuml;ckenum fortzufahren.")
