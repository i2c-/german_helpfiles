; *******************************************************
; Beispiel - Erzeugt einen Ownerdrawn/Colored Button
; *******************************************************
...
Func Example()
	...
	$nButton = GUICtrlCreateButton("", 90, 50, 150, 30)
	GUICtrlSetStyle($nButton, BitOR($WS_TABSTOP, $BS_NOTIFY, $BS_OWNERDRAW)) ; Setzt den Ownerdrawn-Flag

	$nButton2 = GUICtrlCreateButton("Normaler Button", 90, 110, 120, 30)
	...
	While 1
		...
		Switch $GUIMsg
			...
			Case $nButton
				...
				MsgBox(0, "Info", "Button gedr&uuml;ckt")

			Case $nButton2
				; Sollte normalerweise nicht laufen, wegen unserer MY_WM_COMMAND Funktion
				MsgBox(0, "Info", "Button2 gedr&uuml;ckt")
		EndSwitch
	WEnd
EndFunc   ;==>Example
