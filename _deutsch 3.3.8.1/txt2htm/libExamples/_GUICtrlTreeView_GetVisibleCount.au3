...
Func _Main()
	...
	GUICreate("TreeView: Gibt die Anzahl von Items zur&uuml;ck, die komplett sichtbar sind", 550, 300)
	...
	MsgBox(4160, "Information", "Sichtbar: " & _GUICtrlTreeView_GetVisibleCount($hTreeView))
