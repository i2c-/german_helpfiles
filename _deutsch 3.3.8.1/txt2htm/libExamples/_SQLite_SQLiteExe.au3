...
$sIn &= ".separator t" & @CRLF ; W&auml;hle @TAB als Separator
...
; Entferne tempor&auml;re Dateien
FileDelete($sTsvFile)
FileDelete($sDbFile)
...
Func _StringCountOccurance($sSearchString, $sSubString, $fCaseSense = 0) ; Gibt die Anzahl gefundener $sSubString in $sSearchString zur&uuml;ck
	Local $iOccCnt = 1
	Do
