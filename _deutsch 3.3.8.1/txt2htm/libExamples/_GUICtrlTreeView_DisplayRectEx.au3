...
Func _Main()
	...
	GUICreate("TreeView: Gibt das begrenzende Rechteck f&uuml;r ein Treeitem zur&uuml;ck", 500, 300)
	...
	MsgBox(4160, "Information", StringFormat("Item 2 Rechteck : [%d, %d, %d, %d]", DllStructGetData($tRect, "Left"), _
