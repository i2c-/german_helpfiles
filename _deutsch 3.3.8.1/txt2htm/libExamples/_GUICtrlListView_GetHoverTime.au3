...
Func _Main()
	...
	MsgBox(4160, "Information", "Der Mauscursor muss " & _GUICtrlListView_GetHoverTime($hListView) & " Millisekunden (HoverTime)" & @CRLF & "&uuml;ber einem Item stehen, bevor dieses ausgew&auml;hlt wird!")
