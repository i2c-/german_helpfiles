...
Func _Main()
	...
	MsgBox(4096, "Information", "Die Toolbar hat den Stil 'Liste' .: " & $fStyle)
	_GUICtrlToolbar_SetStyleList($hToolbar, Not $fStyle)
	MsgBox(4096, "Information", "Die Toolbar hat den Stil 'Liste' .: " & _GUICtrlToolbar_GetStyleList($hToolbar))
