...
Func _Main()
	...
	; F&uuml;gt eine Gruppe mit dem Toolbar-Control am Anfang der Rebar hinzu
	_GUICtrlRebar_AddToolBarBand($hReBar, $hToolbar)

	; F&uuml;gt eine Gruppe mit dem Inputbox-Control hinzu
	_GUICtrlRebar_AddBand($hReBar, GUICtrlGetHandle($hInput), 120, 200, "Name:")

	; F&uuml;gt eine Gruppe mit dem Combobox-Control hinzu
	...
	MsgBox(4096, "Information", "Gruppe 1 minimieren")
	_GUICtrlRebar_MinimizeBand($hReBar, 1)
	MsgBox(4096, "Information", "Maximiert Gruppe 1 auf die maximale Gr&ouml;&szlig;e")
	_GUICtrlRebar_MaximizeBand($hReBar, 1, False)
	MsgBox(4096, "Information", "Maximiert Gruppe 0 auf die ideale Gr&ouml;&szlig;e")
