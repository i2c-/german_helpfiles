; *****************************************************************
; Beispiel 1 – Nach dem &Ouml;ffnen einer Arbeitsmappe und R&uuml;ckgabe des Objekt-Handles: Setzt die horizontale Ausrichtung der Zellen im Bereich.
; *****************************************************************
...
MsgBox(0, "_ExcelHorizontalAlignSet", "Beachte die Ausrichtung" & @CRLF & "Dr&uuml;cke OK um fortzusetzen")
