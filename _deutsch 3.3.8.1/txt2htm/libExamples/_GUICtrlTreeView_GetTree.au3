...
Func _Main()
	...
	MsgBox(4160, "Information", "Tree f&uuml;r den Child-Index 2: " & _GUICtrlTreeView_GetTree($hTreeView, $hChildItem[2]))
	_GUICtrlTreeView_SelectItem($hTreeView, $hChildItem[2])

	$iRand = Random(0, 29, 1)
	_GUICtrlTreeView_SelectItem($hTreeView, $hChildItem[$iRand])
	MsgBox(4160, "Information", StringFormat("Tree f&uuml;r den markierten Child-Index %d: %s", $iRand, _GUICtrlTreeView_GetTree($hTreeView)))
