...
Func _Main()
	...
	MsgBox(4096, "Information", "Zeigt an, ob das Control 'umbruchf&auml;hig'' ist .: " & $fStyle)
	_GUICtrlToolbar_SetStyleWrapable($hToolbar, Not $fStyle)
	MsgBox(4096, "Information", "Das Control ist 'umbruchf&auml;hig' .: " & _GUICtrlToolbar_GetStyleWrapable($hToolbar))
