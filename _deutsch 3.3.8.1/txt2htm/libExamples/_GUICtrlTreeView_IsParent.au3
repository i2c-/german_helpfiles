...
Func _Main()
	...
	MsgBox(4160, "Information", "Ist Index 2 das Parent vom Child Index 2: " & _GUICtrlTreeView_IsParent($hTreeView, $hItem[2], $hChildItem[2]))

	MsgBox(4160, "Information", "Ist Index 0 das Parent vom Child Index 2: " & _GUICtrlTreeView_IsParent($hTreeView, $hItem[0], $hChildItem[2]))
