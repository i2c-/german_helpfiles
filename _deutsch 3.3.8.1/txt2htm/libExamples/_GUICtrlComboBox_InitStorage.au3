...
Func _Main()
	...
	; Erstellt eine GUI
	GUICreate("ComboBox: Zuweisung von Speicher f&uuml;r die Items", 400, 296)
	$hCombo = GUICtrlCreateCombo("", 2, 2, 396, 296)
	GUISetState()

	; Speicher reservieren
	MsgBox(4160, "Information", "Reservierter Speicher f&uuml;r: " & _GUICtrlComboBox_InitStorage($hCombo, 50, 500) & " Items")
