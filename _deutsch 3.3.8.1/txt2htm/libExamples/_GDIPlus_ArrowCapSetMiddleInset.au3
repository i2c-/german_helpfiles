...
Func _Main()
	...
	_GDIPlus_GraphicsDrawString($hGraphic, 'Pfeill&auml;nge (height) = ' & _GDIPlus_ArrowCapGetHeight($hEndCap) & _
	...
	; Zeichne Pfeil 2 (kr&auml;ftiger Pfeil)
	$iInset = 2
	_GDIPlus_GraphicsDrawString($hGraphic, 'Versatz = ' & $iInset & '   (Kr&auml;ftiger Pfeil)', 10, 70)
	_GDIPlus_ArrowCapSetMiddleInset($hEndCap, $iInset)
	_GDIPlus_PenSetCustomEndCap($hPen, $hEndCap)
	...
	; Zeichne Pfeil 6 (Versatz zu gro&szlig; = kein Pfeil)
	$iInset = 9
	_GDIPlus_GraphicsDrawString($hGraphic, 'Versatz = ' & $iInset & '   (Versatz zu gro&szlig; = kein Pfeil)', 10, 230)
	_GDIPlus_ArrowCapSetMiddleInset($hEndCap, $iInset)
	_GDIPlus_PenSetCustomEndCap($hPen, $hEndCap)
	_GDIPlus_GraphicsDrawLine($hGraphic, 10, 250, 390, 250, $hPen)

	; Zeichne Pfeil 7 (Pfeil nicht gef&uuml;llt)
	$iInset = 1.5
	...
	; Auf Schlie&szlig;en des GUI warten
	Do
