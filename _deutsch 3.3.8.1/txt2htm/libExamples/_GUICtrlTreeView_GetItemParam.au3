...
Func Example_Internal()
	...
	For $x = 0 To 9
		...
		For $y = $iYIndex To $iYIndex + 2
			$hItemChild[$y] = GUICtrlCreateTreeViewItem(StringFormat("[%02d] Neues Child Item", $y), $hItem[$x])
		Next
		$iYIndex += 3
	Next
	...
	$iRand = Random(0, 9, 1)
	MsgBox(4160, "Information", StringFormat("Item Param/ID f&uuml;r Index %d: %s\r\nIsPtr = %d IsHWnd = %d", $iRand, _GUICtrlTreeView_GetItemParam($hTreeView, $hItem[$iRand]), _
			IsPtr(_GUICtrlTreeView_GetItemHandle($hTreeView, $hItem[$iRand])), IsHWnd(_GUICtrlTreeView_GetItemHandle($hTreeView, $hItem[$iRand]))))
	$iRand = Random(0, 29, 1)
	MsgBox(4160, "Information", StringFormat("Item Param/ID f&uuml;r child Index %d: %s", $iRand, _GUICtrlTreeView_GetItemParam($hTreeView, $hItemChild[$iRand])))
...
Func Example_External()
	...
	$iRand = Random(0, 9, 1)
	MsgBox(4160, "Information", StringFormat("Itemparameter f&uuml;r Index %d: %s\r\nIsPtr = %d IsHWnd = %d", $iRand, _GUICtrlTreeView_GetItemParam($hTreeView, $hItem[$iRand]), _
			IsPtr(_GUICtrlTreeView_GetItemHandle($hTreeView, $hItem[$iRand])), IsHWnd(_GUICtrlTreeView_GetItemHandle($hTreeView, $hItem[$iRand]))))
	$iRand = Random(0, 29, 1)
