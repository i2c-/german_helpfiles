...
Func _Main()
	...
	MsgBox(4096, "Information", "&Auml;ndert das Speichern-Bitmap in das Drucken-Bitmap")
	_GUICtrlToolbar_SetButtonBitMap($hToolbar, $idSave, $STD_PRINT)
	MsgBox(4096, "Information", "Index des Speichern-Bitmaps: " & _GUICtrlToolbar_GetButtonBitmap($hToolbar, $idSave))
