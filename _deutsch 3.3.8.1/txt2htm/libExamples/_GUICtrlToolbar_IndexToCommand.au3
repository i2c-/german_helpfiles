...
Func _Main()
	...
	MsgBox(4096, "Information", "Index des Speichern-Buttons ......: " & $iIndex)
	MsgBox(4096, "Information", "Command-ID des Speichern-Buttons .: " & _GUICtrlToolbar_IndexToCommand($hToolbar, $iIndex))
