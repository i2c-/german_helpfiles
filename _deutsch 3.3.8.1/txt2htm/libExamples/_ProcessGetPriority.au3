...
MsgBox(0, "AutoIt Skript", "Priorit&auml;t sollte 2 sein: " & $i_Priority_Level)
...
For $i_ArrayItem = 0 To 2
	...
	MsgBox(0, "Notepad Priorit&auml;t", "Sollte " & $a_RunLevels[$i_ArrayItem] & " sein" & ": " & $i_Priority_Level)
Next
