...
Func _Main()
	...
	GUICreate("ListView: Ermittelt die Anzahl von Arbeitsfl&auml;chen", 400, 300)
	...
	MsgBox(8192 + 64, "Information", "Arbeitsfl&auml;chen: " & _GUICtrlListView_GetNumberOfWorkAreas($hListView))
