...
Func _Main()
	...
	MemoWrite("Kleinstes ausw&auml;hlbares Datum: " & _GUICtrlMonthCal_GetRangeMinStr($hMonthCal))
	MemoWrite("Gr&ouml;&szlig;tes ausw&auml;hlbares Datum: " & _GUICtrlMonthCal_GetRangeMaxStr($hMonthCal))
