...
Func _Main()
	...
	MsgBox(4096, "Information", "Die Toolbar hat den ToolTips-Stil .: " & $fStyle)
	_GUICtrlToolbar_SetStyleToolTips($hToolbar, Not $fStyle)
	MsgBox(4096, "Information", "Die Toolbar hat den ToolTips-Stil .: " & _GUICtrlToolbar_GetStyleToolTips($hToolbar))
