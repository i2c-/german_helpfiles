...
Func _Main()
	...
	; Registriert Bearbeitungsfunktionen f&uuml;r Nachrichten
...
; Bearbeitet WM_COMMAND-Nachrichten
Func WM_COMMAND($hWnd, $iMsg, $iwParam, $ilParam)
	#forceref $hWnd, $iMsg, $ilParam
	Switch $iwParam
		Case $idOpen
			_WinAPI_ShowMsg("&Ouml;ffnen")
		Case $idSave
...
; Bearbeitet WM_CONTEXTMENU-Nachrichten
