...
Func _Main()
	...
	MsgBox(4160, "Information", "Item 0 hat Children? " & _GUICtrlTreeView_GetChildren($hTreeView, $hItem[0]))
	MsgBox(4160, "Information", "Item 10 hat Children? " & _GUICtrlTreeView_GetChildren($hTreeView, $hItem[10]))
