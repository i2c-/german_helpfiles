...
Func _Main()
	...
	If _Net_Share_ShareCheck(@ComputerName, $sShareName) = -1 Then
		...
		If @error Then MsgBox(4096, "Information", "Fehler beim Hinzuf&uuml;gen der Freigabe : " & @error)
	...
	If @error Then MsgBox(4096, "Information", "Fehler beim Entfernen der Freigabe : " & @error)
