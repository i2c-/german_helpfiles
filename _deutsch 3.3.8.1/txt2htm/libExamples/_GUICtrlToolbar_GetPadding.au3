...
Func _Main()
	...
	; Setzt die horizontale und vertikale Einr&uuml;ckung
	_GUICtrlToolbar_SetPadding($hToolbar, 2, 3)

	; Zeigt die horizontale und vertikale Einr&uuml;ckung
	$aPad = _GUICtrlToolbar_GetPadding($hToolbar)
	MemoWrite("Horizontale Einr&uuml;ckung : " & $aPad[0])
	MemoWrite("Vertikale Einr&uuml;ckung ..: " & $aPad[1])
