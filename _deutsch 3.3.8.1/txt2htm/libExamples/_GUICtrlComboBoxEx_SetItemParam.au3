...
Func _Main()
	...
	; Erstellt eine GUI
	$hGUI = GUICreate("ComboBoxEx: Setzt den speziellen Wert f&uuml;r das Item", 500, 300)
	...
	MsgBox(4160, "Information", "Itemparameter: " & _GUICtrlComboBoxEx_GetItemParam($hCombo, 2))
