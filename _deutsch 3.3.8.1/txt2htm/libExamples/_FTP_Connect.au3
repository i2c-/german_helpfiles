...
Func _example1()
	...
	Local $s_Username = ''
	Local $s_Password = ''
	Local $i_Passive = 0 ;aktive Verbindung nutzen wenn bei anderen Server Probleme dann auch mit 1 f&uuml;r passive Verbung testen
	...
	$l_InternetSession = _FTP_Open('AuoItZilla') ;&Ouml;ffnet eine FTP Sitzung
	$errOpen = @error
	If Not @error Then
...
Func _example2()
	...
	Local $s_Username = ''
	Local $s_Password = ''
	Local $i_Passive = 0 ;aktive Verbindung nutzen wenn bei anderen Server Probleme dann ach mit 1 f&uuml;r passive Verbung testen
	Local $l_InternetSession, $l_FTPSession
	Local $errOpen, $errFTP
