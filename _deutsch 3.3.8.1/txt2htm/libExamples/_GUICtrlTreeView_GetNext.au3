...
Func _Main()
	...
	MsgBox(4160, "Information", "Index 2, N&auml;chstes: " & _GUICtrlTreeView_GetNext($hTreeView, $hItem[2]))
	_GUICtrlTreeView_SelectItem($hTreeView, _GUICtrlTreeView_GetNext($hTreeView, $hItem[2]))

	MsgBox(4160, "Information", "Index 4, N&auml;chstes: " & _GUICtrlTreeView_GetNext($hTreeView, $hItem[4]))
