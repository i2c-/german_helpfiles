...
Func _Main()
	...
	GUICreate("TreeView: Legt fest, ob das Item dargestellt wird, als w&auml;re es Teil einer Ausschneide-/ Einf&uuml;ge-Operation", 800, 300)
	...
	MsgBox(4160, "Information", StringFormat("Ist Item %d Teil einer Ausschneide-/ Einf&uuml;ge-Operation %s", $hRandomItem, _GUICtrlTreeView_GetCut($hTreeView, $hItem[$hRandomItem])))
