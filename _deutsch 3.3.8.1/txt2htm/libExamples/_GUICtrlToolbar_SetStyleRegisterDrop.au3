...
Func _Main()
	...
	MsgBox(4096, "Information", "Die Toolbar hat TBN_GETOBJECT Nachrichten erzeugt .: " & $fStyle)
	_GUICtrlToolbar_SetStyleRegisterDrop($hToolbar, Not $fStyle)
	MsgBox(4096, "Information", "Die Toolbar hat TBN_GETOBJECT Nachrichten erzeugt .: " & _GUICtrlToolbar_GetStyleRegisterDrop($hToolbar))
