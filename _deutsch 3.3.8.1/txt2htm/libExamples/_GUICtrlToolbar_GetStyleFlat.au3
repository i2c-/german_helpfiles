...
Func _Main()
	...
	MsgBox(4096, "Information", "Zeigt an, ob die Toolbar flach ist .: " & $fStyle)
	GUISetState(@SW_LOCK)
	_GUICtrlToolbar_SetStyleFlat($hToolbar, Not $fStyle)
	GUISetState(@SW_UNLOCK)
	MsgBox(4096, "Information", "Zeigt an, ob die Toolbar flach ist .: " & _GUICtrlToolbar_GetStyleFlat($hToolbar))
