...
MsgBox(0, "Schritt 5", "&Ouml;ffnen der Ger&auml;teverbindung nur durch Verwenden der Adress-Nummer")
Local $h_instr = _viOpen(3)
MsgBox(0, "Ger&auml;te-Handle bekommen", "$h_instr = " & $h_instr) ; Zeigt das Session Handle
; Das Ger&auml;t abfragen

MsgBox(0, "Schritt 6", "Abfrage der Ger&auml;teverbindung durch Verwenden des VISA Ger&auml;tehandles")
$s_answer = _viExecCommand($h_instr, "*IDN?") ; $h_instr ist zu diesem Zeitpunkt KEIN STRING!
MsgBox(0, "GPIB QUERY Ergebnis", $s_answer) ; Antwort anzeigen
; Noch einmal abfragen. Es ist nicht n&ouml;tig, den Link erneut zu &Ouml;FFNEN

MsgBox(0, "Schritt 7", "Noch einmal abfragen. Es ist nicht n&ouml;tig, den Link erneut zu &Ouml;FFNEN")
$s_answer = _viExecCommand($h_instr, "*IDN?")
MsgBox(0, "GPIB QUERY Ergebnis", $s_answer) ; Antwort anzeigen

MsgBox(0, "Schritt 8", "Schlie&szlig;t die Ger&auml;teverbindung durch Verwenden von _viClose")
