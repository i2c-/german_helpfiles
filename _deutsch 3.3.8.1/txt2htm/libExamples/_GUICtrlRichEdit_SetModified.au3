...
;~ 				GUIDelete() 	; ist auch in Ordnung
			...
			Case $iMsg = $btnNext
				...
				Switch $iStep
					Case 1
						_GUICtrlRichEdit_AppendText($hRichEdit, @CR & "Ein Absatz")
						Report("Text hinzugef&uuml;gt")
					Case 2
						_GUICtrlRichEdit_SetModified($hRichEdit, False)
						Report("Nach dem L&ouml;schen des &Auml;nderungsflags")
					Case 3
						GUICtrlSetData($lblMsg, "Gib etwas ein und klicke dann auf 'Weiter'!")
...
Func Report($sMsg)
	$sMsg = $sMsg & @CR & "Ver&auml;ndert: " & _GUICtrlRichEdit_IsModified($hRichEdit)
