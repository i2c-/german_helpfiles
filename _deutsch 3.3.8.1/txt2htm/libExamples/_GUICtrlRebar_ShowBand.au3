...
Func _Main()
	...
	MsgBox(4096, "Information", "Zum verstecken einer Gruppe wird _GUICtrlRebar_ShowBand verwendet")
	_GUICtrlRebar_ShowBand($hReBar, 0, False)


	MsgBox(4096, "Information", "Zum zeigen einer Gruppe wird _GUICtrlRebar_ShowBand verwendet")
