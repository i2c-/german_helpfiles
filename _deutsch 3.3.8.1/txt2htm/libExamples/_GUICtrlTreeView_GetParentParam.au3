...
Func Example_Internal()
	...
	MsgBox(4160, "Information", "Parent Paramemter/ID: " & _GUICtrlTreeView_GetParentParam($hTreeView, $hChild)) ; Dies entspricht der Control-ID
...
Func Example_External()
	...
	$GUI = GUICreate("TreeView: Ermittelt die Parameter des Parent (UDF)", 400, 300)
	...
	_GUICtrlTreeView_SelectItem($hTreeView, $hChild)
	MsgBox(4160, "Information", "Parent Parameter: " & _GUICtrlTreeView_GetParentParam($hTreeView, $hChild))
