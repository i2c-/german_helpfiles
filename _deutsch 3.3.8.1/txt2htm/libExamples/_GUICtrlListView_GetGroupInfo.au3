...
Func _Main()
	...
	_GUICtrlListView_InsertGroup($hListView, -1, 1, "Gruppe 1", 1) ; Text zentriert
	_GUICtrlListView_InsertGroup($hListView, -1, 2, "Gruppe 2") ; Text linksb&uuml;ndig
	...
	; &Auml;ndert Informationen einer Gruppe
	$aInfo = _GUICtrlListView_GetGroupInfo($hListView, 1)
	MsgBox(4160, "Information", "Bisheriger Text der ersten Gruppe: " & $aInfo[0])
	_GUICtrlListView_SetGroupInfo($hListView, 1, "Neue Gruppe 1") ; Text linksb&uuml;ndig
