...
Func _Main()
	...
	; Erstellt eine GUI
	GUICreate("Month Calendar: Ermittelt den m&ouml;glichen Monats-Bereich", 400, 300)
	...
	; Ermittelt den m&ouml;glichen Monats-Bereich
	MemoWrite("Monats-Bereich: " & _GUICtrlMonthCal_GetMonthRangeSpan($hMonthCal))
