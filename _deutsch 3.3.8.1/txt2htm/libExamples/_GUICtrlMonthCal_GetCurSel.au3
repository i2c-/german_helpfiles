...
Func _Main()
	...
	; Erstellt eine GUI
	GUICreate("MonthCal: Ermittelt das aktuell ausgew&auml;hlte Datum", 450, 300)
	...
	; Ermittelt/Setzt das ausgew&auml;hlte Datum
	_GUICtrlMonthCal_SetCurSel($hMonthCal, @YEAR, 8, 19)
	$tTime = _GUICtrlMonthCal_GetCurSel($hMonthCal)
	MemoWrite("Aktuell ausgew&auml;hltes Datum : " & StringFormat("%02d/%02d/%04d", DllStructGetData($tTime, "Month"), _
