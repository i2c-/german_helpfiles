...
Func Example()
	...
	; Erstellt eine GUI
	$hGUI = GUICreate("ComboBoxEx: Ermittelt den anwendungsspezifischen Wert f&uuml;r das Item", 550, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Anwendungsspezifischer Wert f&uuml;r das Item: " & _GUICtrlComboBoxEx_GetItemParam($hCombo, 2))
