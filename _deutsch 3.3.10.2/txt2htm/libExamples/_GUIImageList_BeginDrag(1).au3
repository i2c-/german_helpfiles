...
Func Example()
	...
	$main_GUI = GUICreate("ImageList: Beginnt mit dem ziehen eines Bildes", 425, 400)

	$hListView = _GUICtrlListView_Create($main_GUI, "Name|Kategorie", 5, 75, 220, 180, -1, BitOR($WS_EX_CLIENTEDGE, $WS_EX_STATICEDGE))
	$LV_Height = 180
