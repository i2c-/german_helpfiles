...
Func Example()
	...
	$hGUI = GUICreate("ComboBoxEx: Bildindex f&uuml;r den markierten Zustand eines Items ermitteln", 520, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Bildindex im ausgew&auml;hlten Zustand f&uuml;r Item 0: " & _GUICtrlComboBoxEx_GetItemSelectedImage($hCombo, 0))
