...
Func Example()
	...
	GUICreate("TreeView: Setzt die Einf&uuml;gemarke", 400, 300)
	...
	$iRand = Random(0, 9, 1)
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Setzt die Einf&uuml;gemarke bei Itemindex[%d]: %s", $iRand, _GUICtrlTreeView_SetInsertMark($hTreeView, $hItem[$iRand])))
