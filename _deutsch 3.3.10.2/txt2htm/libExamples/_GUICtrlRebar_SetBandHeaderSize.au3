...
Func Example()
	...
	$iMemo = GUICtrlCreateEdit("", 2, 40, 396, 200, $WS_VSCROLL)
	...
	$btnExit = GUICtrlCreateButton("Beenden", 150, 260, 100, 25)
	...
	For $x = 0 To _GUICtrlRebar_GetBandCount($hReBar) - 1
		MemoWrite("============================================")
		MemoWrite("Gruppe " & $x & @TAB & "Gr&ouml;&szlig;e der Beschriftung: " & _GUICtrlRebar_GetBandHeaderSize($hReBar, $x))
	Next

	MsgBox($MB_SYSTEMMODAL, "Information", "Setzt die Gr&ouml;&szlig;e der Beschriftung der Gruppe auf 70 Pixel")
