...
Func Example()
	...
	; Erstellt eine GUI
	$hGUI = GUICreate("ComboBoxEx: W&auml;hlt Zeichen aus", 400, 300)
	...
	; W&auml;hlt Zeichen im Edit-Control aus
	...
	MemoWrite(StringFormat("Ausgew&auml;hlt: [%d][%d]", $aSel[0], $aSel[1]))
