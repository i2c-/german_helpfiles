...
Func Example()
	...
	MemoWrite("Die R&auml;nder sind abh&auml;ngig von dem Design-Thema")
	MemoWrite("===================================")
	...
	MemoWrite("Obere H&ouml;he...: " & DllStructGetData($tMargins, "cyTopHeight"))
	MemoWrite("Untere H&ouml;he..: " & DllStructGetData($tMargins, "cyBottomHeight"))
	MemoWrite("======================")
