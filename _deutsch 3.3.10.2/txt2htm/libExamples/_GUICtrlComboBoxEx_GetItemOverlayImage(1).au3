...
Func Example()
	...
	; Erstellt eine GUI
	$hGUI = GUICreate("ComboBoxEx: Ermittelt den Index des Icons in der Imagelist &uuml;ber dem sich die Maus befindet", 700, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Ausgew&auml;hltes Item: " & _GUICtrlComboBoxEx_GetItemSelectedImage($hCombo, 0))
