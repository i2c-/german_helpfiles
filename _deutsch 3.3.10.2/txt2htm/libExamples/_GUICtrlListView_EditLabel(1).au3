...
Func Example()
	...
	$hGui = GUICreate("ListView: &Auml;ndert die Beschreibung von Item 0", 400, 300, Default, Default, Default, $WS_EX_CLIENTEDGE)
	...
	; Erlaubt das &Auml;ndern der Beschreibung von Item 0
