...
; Nach dem &Ouml;ffnen einer Excel-Datei und dem Erhalt der Objekt-ID wird ein Array deklariert und dieses in die Tabelle eingetragen, dann wird gespeichert und die Datei geschlossen.
