...
Func Example()
	...
	GUICreate("TreeView: Ermittelt die H&ouml;he", 400, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Item H&ouml;he? %s", _GUICtrlTreeView_GetHeight($hTreeView)))
