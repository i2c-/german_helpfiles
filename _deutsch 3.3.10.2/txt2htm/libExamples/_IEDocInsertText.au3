...
; &Ouml;ffnet eine Beispiel-Seite mit der Bezeichnung "basic" in einem Browser, f&uuml;gt Text ein in und um den ersten "Paragraph tag" und zeigt den HTML Body-Text.
