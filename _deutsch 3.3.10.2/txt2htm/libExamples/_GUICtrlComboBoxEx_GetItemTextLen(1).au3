...
Func Example()
	...
	; Erstellt eine GUI
	$hGUI = GUICreate("ComboBoxEx: Ermittelt die Textl&auml;nge eines Items", 400, 300)
	...
	; Ermittelt die L&auml;nge eines Strings
	MsgBox($MB_SYSTEMMODAL, "Information", "Textl&auml;nge des Items: " & _GUICtrlComboBoxEx_GetItemTextLen($hCombo, 0))
