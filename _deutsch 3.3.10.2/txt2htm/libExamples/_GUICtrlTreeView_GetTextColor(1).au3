...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Hintergrundfarbe: " & _GUICtrlTreeView_GetBkColor($hTreeView) & @CRLF & _
			"Textfarber: " & _GUICtrlTreeView_GetTextColor($hTreeView) & @CRLF & _
