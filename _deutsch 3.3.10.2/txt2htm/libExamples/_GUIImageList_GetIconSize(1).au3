...
Func Example()
	...
	GUICreate("ImageList: Icongr&ouml;&szlig;e ermitteln", 400, 300)
	...
	MemoWrite("Bilderh&ouml;he  : " & $aSize[1])

	MsgBox($MB_SYSTEMMODAL, "Information", "Es wird die Icongr&ouml;&szlig;e ge&auml;ndert")
