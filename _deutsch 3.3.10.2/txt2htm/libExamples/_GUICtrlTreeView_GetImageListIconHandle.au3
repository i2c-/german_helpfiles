...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Handle der Imagelist f&uuml;r Bild %d? %s", $hRandomImage, _GUICtrlTreeView_GetImageListIconHandle($hTreeView, $hRandomImage)))
