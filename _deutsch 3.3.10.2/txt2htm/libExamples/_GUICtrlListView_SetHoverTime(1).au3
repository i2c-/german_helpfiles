...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Der Mauscursor musste bisher " & _GUICtrlListView_GetHoverTime($hListView) & " Millisekunden (HoverTime)" & @CRLF & "&uuml;ber einem Item stehen, bevor dieses ausgew&auml;hlt wird.")
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Jetzt sind es nur noch " & _GUICtrlListView_GetHoverTime($hListView) & " Millisekunden!")
