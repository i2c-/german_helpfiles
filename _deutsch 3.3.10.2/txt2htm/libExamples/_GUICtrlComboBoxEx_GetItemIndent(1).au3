...
Func Example()
	...
	; Erstellt eine GUI
	$hGUI = GUICreate("ComboBoxEx: Ermittelt die Anzahl von Bilderbreiten die das Item einger&uuml;ckt werden soll", 700, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Einr&uuml;ckung des Items: " & _GUICtrlComboBoxEx_GetItemIndent($hCombo, 2))
