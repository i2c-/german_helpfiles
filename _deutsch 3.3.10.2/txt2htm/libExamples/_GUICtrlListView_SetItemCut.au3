...
Func Example()
	...
	GUICreate("ListView: Item f&uuml;r eine verschieben Operation markieren", 500, 300)
	...
	; Item 2 f&uuml;r eine verschieben Operation markieren
	_GUICtrlListView_SetItemCut($hListView, 1)
	MsgBox($MB_SYSTEMMODAL, "Information", "Item 2: " & _GUICtrlListView_GetItemCut($hListView, 1))
