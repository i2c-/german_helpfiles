...
Func Example()
	...
	; W&auml;hlt den Speichern-Button aus
	MsgBox($MB_SYSTEMMODAL, "Information", "Speichern-Button ausgew&auml;hlt: " & _GUICtrlToolbar_IsButtonHighlighted($hToolbar, $idSave))
