...
Func Example()
	...
	GUICreate("TreeView: Setzt die Farbe die f&uuml;r die Einf&uuml;gemarke verwendet werden soll", 600, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Farbe die f&uuml;r die Einf&uuml;gemarke: " & _GUICtrlTreeView_GetInsertMarkColor($hTreeView))
