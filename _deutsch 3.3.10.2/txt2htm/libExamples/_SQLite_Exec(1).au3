...
$d = _SQLite_Exec(-1, "Select oid,* From tblTest", "_cb") ; _cb wird f&uuml;r jede Zeile aufgerufen
...
Func _cb($aRow)
	...
	Next
	ConsoleWriteCRLF)
	; R&uuml;ckgabewert: $SQLITE_ABORT ; Bricht den Prozess ab und setzt @error in _SQLite_Exec()
EndFunc   ;==>_cb
_SQLite_Close()
_SQLite_Shutdown()
