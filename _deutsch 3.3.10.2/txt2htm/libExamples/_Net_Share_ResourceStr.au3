...
Func Example()
	...
	$sServer = InputBox("Netzwerk Demo", "Gib den Servernamen ein:", "\\.", "", 200, 130) ; \\. f&uuml;r den lokalen Computer
	If @error Then Exit
