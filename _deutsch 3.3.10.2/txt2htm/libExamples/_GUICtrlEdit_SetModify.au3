...
Func Example()
	...
	; Erstellt eine GUI
	$hGUI = GUICreate("Edit: Setzt oder l&ouml;scht das &Auml;nderungsflag", 400, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Setzt oder l&ouml;scht das &Auml;nderungsflag")
