...
Func Example()
	...
	GUICreate("TreeView: N&auml;chstes Item ermitteln", 400, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Index 2, N&auml;chstes: " & _GUICtrlTreeView_GetNext($hTreeView, $hItem[2]))
	_GUICtrlTreeView_SelectItem($hTreeView, _GUICtrlTreeView_GetNext($hTreeView, $hItem[2]))

	MsgBox($MB_SYSTEMMODAL, "Information", "Index 4, N&auml;chstes: " & _GUICtrlTreeView_GetNext($hTreeView, $hItem[4]))
