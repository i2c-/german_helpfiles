...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Zeigt an, ob das Control 'umbruchf&auml;hig'' ist .: " & $fStyle)
	_GUICtrlToolbar_SetStyleWrapable($hToolbar, Not $fStyle)
	MsgBox($MB_SYSTEMMODAL, "Information", "Das Control ist 'umbruchf&auml;hig' .: " & _GUICtrlToolbar_GetStyleWrapable($hToolbar))
