...
Func Example()
	...
	GUICreate("TreeView: Gibt das vorherige Item des aufrufenden Items zur&uuml;ck", 400, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Index %d, Vorheriges: %s", $hRandItem, _GUICtrlTreeView_GetPrevSibling($hTreeView, $hItem[$hRandItem])))
