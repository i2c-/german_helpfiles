...
; Schreibt in eine Zelle unter Verwendung einer Schleife, liest die Zellen in ein Array ein, zeigt dieses an, dann wird gespeichert und die Datei geschlossen.
