...
Func Example()
	...
	GUICreate("TreeView: Setzt den Index in die Imagelist f&uuml;r das Statusbild", 550, 300)
	...
	For $x = 0 To 9
		...
		For $y = 1 To 3
			$hChildItem[$iYItem] = _GUICtrlTreeView_AddChild($hTreeView, $hItem[$x], StringFormat("[%02d] Neues Child", $y))
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Index des Statusbildes f&uuml;r Item 0: " & _GUICtrlTreeView_GetStateImageIndex($hTreeView, $hItem[0]))
