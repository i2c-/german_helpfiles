...
Func Example()
	...
	$iRand = Random(0, 9, 1)
	_GUICtrlTreeView_SetText($hTreeView, $hItem[$iRand], "Dieser Text wurde gesetzt")
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Text f&uuml;r Item %d: %s", $iRand, _GUICtrlTreeView_GetText($hTreeView, $hItem[$iRand])))
