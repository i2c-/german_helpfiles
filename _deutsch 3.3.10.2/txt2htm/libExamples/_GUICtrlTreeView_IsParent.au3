...
Func Example()
	...
	GUICreate("TreeView: Zeigt an, ob ein Item in der Hierarchie &uuml;ber einem anderen Item steht", 600, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Ist Index 2 das Parent vom Child Index 2: " & _GUICtrlTreeView_IsParent($hTreeView, $hItem[2], $hChildItem[2]))

	MsgBox($MB_SYSTEMMODAL, "Information", "Ist Index 0 das Parent vom Child Index 2: " & _GUICtrlTreeView_IsParent($hTreeView, $hItem[0], $hChildItem[2]))
