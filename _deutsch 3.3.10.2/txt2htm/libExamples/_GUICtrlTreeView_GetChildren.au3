...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Item 0 hat Children? " & _GUICtrlTreeView_GetChildren($hTreeView, $hItem[0]))
	MsgBox($MB_SYSTEMMODAL, "Information", "Item 10 hat Children? " & _GUICtrlTreeView_GetChildren($hTreeView, $hItem[10]))
