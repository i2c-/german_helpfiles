...
Func Example()
	...
	; Erstellt eine GUI
	GUICreate("ListView: Findet das n&auml;chste Item", 400, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Das n&auml;chste Item [100, 10]: " & $iIndex)

	$iIndex = _GUICtrlListView_FindNearest($hListView, 200, 10)
	MsgBox($MB_SYSTEMMODAL, "Information", "Das n&auml;chste Item [200, 10]: " & $iIndex)
