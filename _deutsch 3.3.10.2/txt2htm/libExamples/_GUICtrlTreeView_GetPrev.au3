...
Func Example()
	...
	GUICreate("TreeView: Ermittelt den Vorg&auml;nger", 400, 300)
	...
	For $x = 0 To 3
		...
		For $y = 1 To Random(2, 10, 1)
			GUICtrlCreateTreeViewItem(StringFormat("[%02d] Neues Child", $iYItem), $hItem[$x])
			$iYItem += 1
		Next
	Next
	...
	$iRand = Random(0, 9, 1)
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Vorg&auml;nger von Index %d: %s", $iRand, _GUICtrlTreeView_GetPrev($hTreeView, $hItem[$iRand])))
