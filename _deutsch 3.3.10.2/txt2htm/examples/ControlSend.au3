...
Func Example()
	...
	; Sendet einen Textstring an das Edit-Control des Editors. Dabei wird f&uuml;r den "title" Parameter von ControlSend das von WinWait zur&uuml;ckgegebenen Handle verwendet.
