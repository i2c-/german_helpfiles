; Jede Zeile zum &Auml;ndern kopieren   ; Der Standardwert ist als erstes angegeben

Opt("CaretCoordMode", 1)        ; 1=absolut, 0=relativ, 2=rel. zur Fensterfl&auml;che(client)
Opt("ExpandEnvStrings", 0)      ; 0=nicht auswerten, 1=auswerten
Opt("ExpandVarStrings", 0)      ; 0=nicht auswerten, 1=auswerten
Opt("GUICloseOnESC", 1)         ; 1=ESC beendet, 0=ESC schlie&szlig;t nicht
Opt("GUICoordMode", 1)          ; 1=absolut, 0=relativ, 2=rel. zur Fensterfl&auml;che(client)
Opt("GUIDataSeparatorChar","|")	; "|" ist der Standard
Opt("GUIOnEventMode", 0)        ; 0=ausgeschaltet, 1=OnEvent Modus aktiviert
Opt("GUIResizeMode", 0)         ; 0=keine Gr&ouml;&szlig;en&auml;nderung, konfigurierte Gr&ouml;&szlig;en&auml;nderung (<1024)
...
Opt("MouseCoordMode", 1)        ; 1=absolut, 0=relativ, 2=rel. zur Fensterfl&auml;che(client)
Opt("MustDeclareVars", 0)       ; 0=nein, 1=erfordert Deklaration
Opt("PixelCoordMode", 1)        ; 1=absolut, 0=relativ, 2=rel. zur Fensterfl&auml;che(client)
...
Opt("TrayMenuMode", 0)			; 0=anf&uuml;gen, 1=kein Standardmen&uuml;, 2=kein autom. An-/Abhaken, 4=menuitemID nicht zur&uuml;ckgeben
...
Opt("WinTextMatchMode", 1)      ; 1=vollst&auml;ndig, 2=schnell
Opt("WinTitleMatchMode", 1)     ; 1=vom Anfang, 2=enth&auml;lt, 3=genau, 4=fortgeschritten, -1 bis -4=Gro&szlig;-/Klein ignorieren
