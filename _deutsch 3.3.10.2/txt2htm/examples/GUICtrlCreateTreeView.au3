		...
		Select
			...
			Case $msg = $infobutton
				...
				Else
					...
					Else
						MsgBox($MB_SYSTEMMODAL, "Treeview Demo", "Aktuell gew&auml;hltes Item ist: " & $text) ; $advmsg[0] enth&auml;lt den Text und $advmsg[1] den Statuswert des Treeview-Items
					EndIf
				EndIf
