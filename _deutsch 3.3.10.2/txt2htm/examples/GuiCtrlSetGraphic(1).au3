...
Global $a[$MAXGr + 1] ; 0 und $MAXGr-Eintr&auml;ge werden nicht f&uuml;r GUICtrlDelete benutzt
...
Func Example()
	...
	$del1 = GUICtrlCreateButton("L&ouml;schen", 50, 200, 50)
	GUISetState(@SW_SHOW)
	CreateChild()

	$i = 1
	$inc = 1
	;$i=5	; Auskommentieren um den L&ouml;schvorgang bei dem zuletzt definierten Grafik-Control zu beginnen
	;$inc=-1
...
Func CreateChild()
	...
	GUICtrlSetGraphic(-1, $GUI_GR_COLOR, 0, 0xff); Mit Blau f&uuml;llen
